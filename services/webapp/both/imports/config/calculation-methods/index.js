...
const geometryOptimizationMethods = [
  ...
  },
  {
    ...
    prettyName: "Unrestricted Hatree Fock",
    type: "geometryOptimization",
    program: "psi4"
  }, {
    value: "dft",
...
const calculationMethods = _.concat(geometryOptimizationMethods, groundStateMethods, excitedStateMethods, periodicBoundaryConditionMethods);
