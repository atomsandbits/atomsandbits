...
import SecondaryXyzRenderer from './components/SecondaryXyzRenderer';
...
const CalculationOptionsPure = ({
  ...
  <OptionsContainer>
    ...
    />
    <SecondaryXyzRenderer
      type={parameters.type}
      method={parameters.method}
      secondaryXyz={parameters.secondaryXyz}
      setsecondaryXyz={setParameter('secondaryXyz')}
      unsetsecondaryXyz={unsetParameter('secondaryXyz')}
    />
  </OptionsContainer>
);
