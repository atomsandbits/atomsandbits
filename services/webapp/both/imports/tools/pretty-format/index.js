...
const allProperties = _.concat(calculationTypes, periodicCalculationTypes, calculationMethods, networks, densityFits, basisSets, auxBasisSets, pseudoPotentials, functionals, multiplicities);
