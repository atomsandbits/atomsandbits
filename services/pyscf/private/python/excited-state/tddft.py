...
aux_basis_set = results.aux_basis_set if results.aux_basis_set and results.aux_basis_set != 'undefined' else None
pseudo_potential = results.pseudo_potential if results.pseudo_potential and results.pseudo_potential != 'undefined' else None
